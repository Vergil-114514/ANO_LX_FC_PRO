...
#define ANOPTV8DEVID_PMU	(0xD0)
#define ANOPTV8DEVID_MY		(ANOPTV8DEVID_MCU)
...
#define ANOPTV8DEVID_UART6	(0x06)
#define ANOPTV8DEVID_UART7	(0x07)
#define ANOPTV8DEVID_UART8	(0x08)
//数据优先级定义，数字越小，优先级越高
#define ANOPTV8TXPRI_CMD	(1)
#define ANOPTV8TXPRI_DATA	(10)
#define ANOPTV8TXPRI_INFO	(20)
#define ANOPTV8TXPRI_DEFAULT	(200)
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
设备相关定义，可以修改
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define ANOPTV8_HWVER		(100)
#define ANOPTV8_SWVER		(100)
#define ANOPTV8_BLVER		(0)
#define ANOPTV8_PTVER		(800)
#define ANOPTV8_DEVNAME		"AnoMCU"	//DEVNAME：设备名称

#define ANOPTV8_PAR_MAXCOUNT	512
#define ANOPTV8_CMD_MAXCOUNT	128

#define ANOPTV8_MAXSENDFRAME1MS	5
#define ANOPTV8_SENDBUFLEN 		20
...
#define LT_U7	((uint16_t)1<<5)
#define LT_U8	((uint16_t)1<<6)
